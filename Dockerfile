...
HEALTHCHECK --interval=30s --timeout=10s --retries=3 --start-period=5s CMD curl -f http://127.0.0.1:${ITKO_MONITOR_LISTEN_PORT:-80}/ct/v1/get-sth | grep '"tree_size":' || exit 1
